...
from .db_pool import DatabaseConnectionPool, get_global_pool
...
async def get_kafka_producer() -> KafkaProducerService:
    ...
    if _kafka_producer is None:
        raise RuntimeError("Kafka producer not initialized. Call initialize_dependencies() first.")
...
async def get_gemini_client() -> ResilientGeminiClient:
    ...
    if _gemini_client is None:
        raise RuntimeError("Gemini client not initialized. Call initialize_dependencies() first.")
