...
TRANSITION_RULES = {
    ...
    RelationshipState.RECOVERY: {
        RelationshipState.HARMONY: {
            ...
            "required_signals": ["back to normal", "resolved", "good again", "fine now"],
        },
        RelationshipState.CONFLICT: {
            "condition": "relapse",
...
class RelationshipStateMachine:
    ...
    def get_status_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "impact": impact,
            "expected_resolution_date": expected_resolution.isoformat() if expected_resolution else None,
...
class RelationshipImpactCalculator:
    ...
    def apply_relationship_impact(
        ...
        if "mood_score" in base_values or "mood_score_estimate" in base_values:
            mood_key = "mood_score" if "mood_score" in base_values else "mood_score_estimate"
        ...
        if "sleep_quality" in base_values:
            ...
            adjusted_quality = max(1, min(10, round(base_quality + quality_adjustment, 1)))
