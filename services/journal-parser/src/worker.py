...
class JournalProcessingWorker:
    ...
    async def _process_message(self, message: Dict[str, Any]):
        ...
        try:
            ...
            logger.info(f"Processing task {task_id} for user {user_id} (priority: {priority})")
...
async def run_worker():
    ...
    from shared.utils.db_pool import initialize_global_pool, get_global_pool
    ...
    kafka_consumer = KafkaConsumerService(
        ...
        group_id="journal-processor-workers"
    )
