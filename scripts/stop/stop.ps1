...
if ($CleanVolumes) {
    ...
    Write-Host "To also remove data: ./scripts/stop/stop.ps1 -CleanVolumes" -ForegroundColor Gray
}

Write-Host ""
Write-Host "To start: ./scripts/start/start-all.ps1" -ForegroundColor Gray
Write-Host ""
